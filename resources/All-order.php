            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index.php" class="nav-link" style="font-size: 20px; font-weight: bold;"> <i
                            class="nav-icon fas fa-home"></i>All Orders</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item active">
                            <a class="nav-link" href="#">Performance Overview</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="form-inline my-2 my-lg-0 " style="flex-direction: column;display: flex; color: black;">
                        <h5>Placed Date</h5>
                        <button type="button" class="btn btn-outline-secondary">3/7/2023 - 4/3/2023 <svg
